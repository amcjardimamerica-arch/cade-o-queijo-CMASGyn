...
ECONOMIA = {
  ...
  "2_prefixo_estavel": {
    "o_que": "O bloco de sistema e o corpus vão sempre na mesma ordem de bytes, "
             "o que permite cache de prompt.",
    "ganho": "entrada em cache custa fração do preço normal"},
  "3_recorte_por_ancora": {
    "o_que": "recortar() manda a vizinhança do termo, não o documento. "
             "Um Diário Oficial tem 14 MB; o trecho útil tem 2 KB.",
    "ganho": "reduz a entrada em três ordens de grandeza"},
  "4_camada_zero": {
    "o_que": "Metade das tarefas é determinística e não vai para modelo nenhum.",
    "ganho": "53% das tarefas a custo zero"},
  "5_triagem_antes_do_parecer": {
    "o_que": "Haiku decide se o ato é relevante. Só o que passa vai para Sonnet.",
    "ganho": "corta o volume que chega à camada cara"},
  "6_destilado_com_teto": {
    "o_que": "docs/CONSULTA.md tem teto rígido de caracteres e corta pelo fim.",
    "ganho": "o chat lê kilobytes de um repositório que processa megabytes"},
  "7_dupla_etapa_condicional": {
    "o_que": "A segunda via só roda sobre suspeita de uso indevido. "
             "Ausência documental não aciona.",
    "ganho": "evita reprocessar achado já conclusivo"},
  "8_cache_de_repasses": {
    "o_que": "A planilha do Fundo Nacional é grande e muda uma vez por mês; "
             "fica em estado/fnas e no cache do fluxo de trabalho.",
    "ganho": "um download por mês em vez de um por execução"},
}
